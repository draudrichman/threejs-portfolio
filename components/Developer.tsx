...
type DeveloperProps = {
    animationName?: AnimationName; // Optional, defaults to 'idle'
} & Partial<THREE.Group>;
...
const Developer = ({ animationName = "idle", ...props }: DeveloperProps) => {
    ...
    // Type the animations array and rename them
    ...
    animations[1].name = "salute";
    animations[2].name = "clapping";
    animations[3].name = "victory";
