...
import * as THREE from 'three'; // Import Three.js for type access

// Define minimal props type based on THREE.Group
type HackerRoomProps = Partial<THREE.Group>; // Use Partial to make all props optional
